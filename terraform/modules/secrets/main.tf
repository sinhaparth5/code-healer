...
resource "aws_secretsmanager_secret_policy" "github_token" {
  secret_arn = aws_secretsmanager_secret.github_token.arn
  policy     = data.aws_iam_policy_document.secrets_policy.json
}

resource "aws_secretsmanager_secret_policy" "slack_token" {
  secret_arn = aws_secretsmanager_secret.slack_token.arn
  policy     = data.aws_iam_policy_document.secrets_policy.json
}
